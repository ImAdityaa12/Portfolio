    ...
    >
      ...
      >
        ...
        <a
          ...
          target="_blank"
          className="bg-white p-4 text-gray-700 flex items-center rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition  borderBlack"
        >
          <BsLinkedin />
        </a>
        <a
